...
if nav == "Prediction":
    ...
    crim = st.number_input("Enter crim",0.00,0.10,step=0.01)
    zn = st.number_input("Enter zn",0.0,19.00,step=1.00)
    indus = st.number_input("Enter indus",0.0,15.00,step=1.00)
    chas = st.number_input("Enter chas",0.0,5.00,step=1.00)
    nox = st.number_input("Enter nox",0.0,1.00,step=0.01)
    rm = st.number_input("Enter rm",0.0,10.00,step=1.00)
    age = st.number_input("Enter your age",0.0,100.00,step=5.00)
    dis = st.number_input("Enter dis",0.0,10.00,step=1.00)
    rad = st.number_input("Enter rad",0.0,100.00,step=5.00)
    tax = st.number_input("Enter tax",0.0,100.00,step=5.00)
    ptratio = st.number_input("Enter ptratio",0.0,100.00,step=5.00)
    black = st.number_input("Enter black",0.0,100.00,step=5.00)
    lstat = st.number_input("Enter lstat",0.0,100.00,step=5.00)
...
if nav == "Contribute":
    st.header("Contribute to our dfset")
